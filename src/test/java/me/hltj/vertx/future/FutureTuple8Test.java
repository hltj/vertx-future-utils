...
class FutureTuple8Test {
    ...
    void basic() {
        ...
        assertEquals(
                "FutureTuple8(Future{result=null}, Future{unresolved}, Future{result=true}, " +
                        "Future{result=1.0}, Future{result=a}, Future{result=1}, Future{result=1.0}, Future{result=1})",
                tuple.toString()
        );
    }
